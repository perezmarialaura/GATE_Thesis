void Extract_Data_FilterWater(const char *filename="S1_Filter_Water.root", const char *outname="S1_Filter_Water.txt", const char *title1="Edep histogram - Moderated AmBe source, filtered", const char *title2="Edep histogram - Moderated AmBe source, filtered (centre pixel)")
{
    gROOT->Reset();
