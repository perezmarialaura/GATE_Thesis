void Extract_Data_AmGamma(const char *filename="Am241.root", const char *outname="GammaTest_Am241.txt", const char *title1="Edep histogram - Am241 source", const char *title2="Edep histogram - Am241 source (centre pixel)")
{
    gROOT->Reset();
