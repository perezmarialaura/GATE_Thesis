void Extract_Data_ThermalFilter2(const char *filename="S0_100eV_F.root", const char *outname="S0_100eV_F.txt", const char *title1="Edep histogram - 20 eV neutrons, filtered", const char *title2="Edep histogram - 20 eV neutrons, filtered (centre pixel)")
{
    gROOT->Reset();
